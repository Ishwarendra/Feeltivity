...
export const ProfileCard = ({
  ...
  return (
    <div className="grid grid-cols-1 bg-[#202938] w-[90vw] sm:w-[45vw] md:w-[40vw] min-h-[300px] rounded-lg">
      {/* Some Image */}
      <div className="flex flex-wrap justify-center">
        <div className="p-5">
          <img
            src={profileImg}
            alt="..."
            className="shadow rounded-full h-[200px] w-[200px] align-middle border-none"
          />
        </div>
      </div>
      ...
      <div className="mx-4">
        ...
        <div className="mb-4 mt-2 flex">
          <div className='mr-1'>
            <LinkedInIcon sx={{ color: "#9ca2ae" }} />
          </div>
          <div className='ml-1'>
            <GitHubIcon sx={{ color: "#9ca2ae" }} />
          </div>
        </div>
      </div>
    </div>
